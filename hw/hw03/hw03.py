...
def missing_digits(n):
    ...
    "*** YOUR CODE HERE ***"
    the_last = n % 10
    after_the_last = n // 10 % 10
    gap = the_last - after_the_last
    if gap == 0:
        return missing_digits(n // 10)
    elif after_the_last == 0:
        return 0
...
def count_change(total):
    ...
    """
    "*** YOUR CODE HERE ***"
    def helper(total, coin_value):
        if total == 0:
            return 1
        elif coin_value > total or total < 0:
            return 0
        else:
            return helper(total - coin_value, coin_value) + helper(total, coin_value * 2)
