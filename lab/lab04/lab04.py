...
def reverse_iter(lst):
   ...
   reverse_iter >>> print("Do not use lst[::-1], lst.reverse(), or reversed(lst)!") if any([r in cleaned for r in ["[::", ".reverse", "reversed"]]) else None
    """
    "*** YOUR CODE HERE ***"
    index = len(lst)
    new = []
    while index > 0:
        new.append(lst[index - 1])
        index -= 1
    return new
...
def reverse_recursive(lst):
   ...
   reverse_recursive >>> print("Do not use lst[::-1], lst.reverse(), or reversed(lst)!") if any([r in cleaned for r in ["[::", ".reverse", "reversed"]]) else None
    """
    "*** YOUR CODE HERE ***"
    if not lst:
        return []
...
def closer_city(lat, lon, city_a, city_b):
    ...
    da = distance(c, city_a)
    db = distance(c, city_b)
