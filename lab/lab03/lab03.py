...
def num_eights(x):
    ...
    """
    "*** YOUR CODE HERE ***"
    # all_but_the_last, the_last = x // 10, x % 10
    #
    # if the_last == 8:
    #     return num_eights(all_but_the_last) + 1
    # elif all_but_the_last == 0:
    #     return 0
    # else:
    #     return num_eights(all_but_the_last)
    if x == 0:
        return 0
